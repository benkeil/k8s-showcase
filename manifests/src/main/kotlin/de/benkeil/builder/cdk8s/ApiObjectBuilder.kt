...
abstract class ApiObjectBuilder<
    ApiObjectType : ApiObject,
    BuilderType : software.amazon.jsii.Builder<ApiObjectType>,
    SelfType : ApiObjectBuilder<ApiObjectType, BuilderType, SelfType>,
>(
    internal val scope: Construct,
    id: String,
    resourceTypeName: GroupVersionKind,
  ...
  private fun createId(type: GroupVersionKind, givenId: String) = givenId
